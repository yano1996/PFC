...
<html>
    <head>
        ...
        <script src="../framework/jquery.maskedinput-master/lib/jquery-1.9.0.min.js" type="text/javascript"></script>
                    ...
                    <ul id="slide-out" class="side-nav fixed leftside-navigation">
                            ...
                            <ul class="collapsible" data-collapsible="accordion">
                                ...
                                <li class="bold">
                                    <a class="collapsible-header waves-effect waves-cyan">
                                        ...
                                        <span class="letra123 nav-text">Paciente</span>
                                    </a>
                                    <div class="collapsible-body">
                                        <ul>
                                            <li class="bold">
                                                <form action="../ControleUsuario" method="POST">
                                                    <a class=" waves-effect waves-cyan black-text"><input type="submit" name="acao" value="Consultar Pacientes"><i class="material-icons blue-text">keyboard_arrow_right</i>
                                                    </a>
                                                </form>
                                            </li>
                                            <li class="bold">

                                                <a href="../paginas_usuario/cadastro_usuario.jsp" class="collapsible-header waves-effect waves-cyan">
                                ...
                                <li class="bold">
                                    <a class="collapsible-header waves-effect waves-cyan">
                                        <i class="material-icons blue-text">search</i>
                                        <span class="letra123 nav-text">Insumos</span>
                                    </a>
                                    <div class="collapsible-body">
                                        <ul>
                                            <li>
                                                <form action="../ControleRestricoes" method="POST">
                                                    <a class="collapsible-header waves-effect waves-cyan black-text"><i class="material-icons blue-text">search</i>
                                                        <input type="submit" name="acao" value="CadastrarVacinas">
                                                    </a>
                                                </form>
                        ...
                        <li class="bold">
                            <a href="" class="waves-effect waves-cyan">
                                ...
                                <span class="nav-text letra123">Operadores</span>
                            </a>
                        </li>
