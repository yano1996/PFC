...
public class VacinaDAO {
    ...
    private final String CADASTRA_NOVA_VACINA = "INSERT INTO vacina (vacina_nome, vacina_dose, vacina_intervalo, vacina_tipo, vacina_status) VALUES (?, ?, ?, ?, ?) RETURNING vacina_id";
    ...
    private final String UPDATE_VACINA = "UPDATE vacina SET vacina_nome=?, vacina_dose=?, vacina_intervalo=?, vacina_tipo=? WHERE vacina_id=?";
    ...
    public Integer cadastaNovoVacina(Vacina vacina) {
        ...
        try {
            ...
            pstmt.setInt(2, vacina.getDose());
            pstmt.setInt(3, vacina.getIntervalo());
            pstmt.setString(4, vacina.getTipo().toString());
            pstmt.setBoolean(5, vacina.isStatus());
    ...
    public ArrayList<Vacina> ConsultarVacinas() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                vacina.setDose(rs.getInt("vacina_dose"));
                vacina.setTipo(TipoVacina.valueOf(rs.getString("vacina_tipo")));
                vacina.setIntervalo(rs.getInt("vacina_intervalo"));
                vacina.setStatus(rs.getBoolean("vacina_status"));
                
                //Precisa ser testado não tenho certeza se funciona
            //  vacina.setRestricoes(coverteIntToStr.coverteStrToVetor(rs.getString("vacina_restricoes")));
    ...
    public void atualizar_vacina(Vacina vacina) {
        ...
        try {
            ...
            pstmt.setInt(3, vacina.getIntervalo());
            pstmt.setString(4, vacina.getTipo().toString());
            pstmt.setInt(5, vacina.getId_vacina());
