                ...
                <form class="login-form" action="ControleAcesso" method="POST">
                    <div class="row margin">           
                        <div class="input-field col s12">
                            ...
                            <input id="rg" name='txtRg' placeholder="Digite Seu RG" type="text" size="10" maxlength=10>
                            <label for="rg" class="center-align">RG</label>
                        </div>
                    </div>
                    <div class="row margin">
                        <div class="input-field col s12">
                    ...
                    <div class="row">        
                        <div class="input-field col s6 m6 l6">
                            <p class="margin right-align medium-small"><a href="paginas_usuario/cadastro_usuario.jsp">Esqueceu sua senha?</a></p>
                        </div>          
                    </div>                    
                </form>
            </div>
