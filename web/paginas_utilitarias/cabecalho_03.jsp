                    ...
                    <ul id="slide-out" class="side-nav fixed leftside-navigation">
                        ...
                        <li class="no-padding">
                            <ul class="collapsible" data-collapsible="accordion">
                                <li class="bold">
                                    <a href="#" class="collapsible-header waves-effect waves-cyan active">
                                        ...
                                        <ul>
                                            <li class="bold">
                                                <form action="#" method="POST">
                                                    <a class=" waves-effect waves-cyan black-text"><input type="submit" name="acao" value="-"><i class="material-icons blue-text">keyboard_arrow_right</i>
                                                    </a>
                                                </form>
                                            </li>
                                            <li class="bold">
